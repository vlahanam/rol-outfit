...
import { LayoutDashboard, Users, Package, ShoppingCart, ClipboardList, Tags, Tag, LayoutPanelLeft, Settings, X, Star } from 'lucide-react';
...
export function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: LayoutPanelLeft, label: 'Widgets', path: '/admin/widgets' },
