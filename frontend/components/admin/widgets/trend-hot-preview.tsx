...
export function TrendHotPreview({
  items,
  activeIndex,
  onActiveChange,
  cardHeight = 400,
  ...
  const cardWidth = isMobile ? Math.round(previewHeight * 0.6) : Math.round(previewHeight * 0.75);
        ...
        {items.map((item, i) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
              <h3 className={`font-bold mb-1 ${isMobile ? "text-xs" : "text-sm"}`}>
